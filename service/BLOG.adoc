...
But it did take a few seconds, didn't it? Which, again, I don't begrudge the computer that time. It did a splendid job! I couldn't do that any faster. Just look at the story it rendered!
