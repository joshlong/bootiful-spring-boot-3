...
CMD+Shift+F9 and then visit the endpoint. The LLM might take a few seconds to produce a response, so get that cup of coffee,  water, or whatever ready for a quick sip. There it is! We live in an age of miracles! The age of the freaking singularity! You can do anything now.
