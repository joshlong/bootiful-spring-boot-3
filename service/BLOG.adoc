...
Things change. There are always new frontiers. Right now, the new frontier is *Artificial Intelligence*, or A.I. A.I.: because the search for good ol' *Intelligence* clearly wasn't hard enough.
